...
import 'package:login_page/src/theme/background_animation.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        Positioned.fill(child: Particles(40)),
        // Positioned.fill(child: UserCenteredText()),
        // Positioned.fill(child: PassCenteredText()),
...
// class UserCenteredText extends StatelessWidget {
//   const UserCenteredText({Key key}) : super(key: key);
...
// class PassCenteredText extends StatelessWidget {
//   const PassCenteredText({Key key}) : super(key: key);
